...
public interface ICwmsRating extends IRating {
	 ...
	 */
    void setRatingSpecId(String ratingSpecId);
	/**
	 ...
	 */
    void setRatingUnitsId(String ratingUnitsId);
	/**
	 ...
	 */
    void setDataUnitsId(String dataUnitsId);
	/**
	 ...
	 */
    String toXmlString(CharSequence indent, int indentLevel) throws RatingException;
