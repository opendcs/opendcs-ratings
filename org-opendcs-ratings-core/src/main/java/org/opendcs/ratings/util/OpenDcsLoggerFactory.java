package org.opendcs.ratings.util;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Intentionally duplciated from the main code, just in a different package space.
 * Future would should identify these types of shared elements and create a separate
 * repostory for them.
 * OpenDcsLoggerFactory
 */
