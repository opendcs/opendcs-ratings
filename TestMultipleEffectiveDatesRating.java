...
public class TestMultipleEffectiveDatesRating
{
	...
	public final void test() throws Exception
	{
		...
		Assert.assertEquals("First value should be equal", ratedValuesOneEffectiveDate[0], ratedValuesTwoEffectiveDates[0]);
		
		//this is where the test will fail
		Assert.assertEquals("Second value should be equal", ratedValuesOneEffectiveDate[1], ratedValuesTwoEffectiveDates[1]);
